...
void test_mainwindow::test_analysis_queue() {
    ...
    mainwindow->add_analysis_to_tree(QString::fromStdString(TEST_1), video_in_tree);
    mainwindow->add_analysis_to_tree(QString::fromStdString(TEST_2), video_in_tree);
    mainwindow->add_analysis_to_tree(QString::fromStdString(TEST_3), video_in_tree);
