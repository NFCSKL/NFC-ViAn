 ...
 */
void ReportGenerator::resize_picture(QString pic_path, QAxObject* inlineShape)
{
    ...
    inlineShape->dynamicCall( "Height", (multiply_factor*original_height));
    inlineShape->dynamicCall( "Width", IMAGE_WIDTH_REFERENCE);
}
 ...
 * to save file names that have e colon in the name.
